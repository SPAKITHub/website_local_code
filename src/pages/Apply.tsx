...
const Apply = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Apply for {jobTitle} - SPAK IT Hub</title>
        <meta
          name="description"
          content={`Apply for ${jobTitle} position at SPAK IT Hub. Join our innovative team and build your career in technology.`}
        />
      </Helmet>
